                                    ...
                                    <div class="order-body mt-8 d-flex ">
                                        <div class="order-detail w-100">
                                            <div class="display-grid">
                                                ...
                                                <div class="fs-5 fs-w-400">Horario de retiro:
                                                    {{order.store.opening_hours}} a
                                                ...
                                                <div class="d-flex align-items-center justify-content-between mb-2"
                                                    ...
                                                    <div class="fs-5 fs-w-400">${{product | calculateDiscount |
                                                        moneyFormat}}</div>
                                                </div>
                                                <div class="separator"></div>
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <div class="fs-5 fs-w-600 mt-3">${{order.total_amount |
                                                        moneyFormat}}</div>
                                                </div>
